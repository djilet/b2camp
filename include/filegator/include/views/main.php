...
<div id="newfolder_button" class="navigation-button-right">
 <input type="text" class="inputtext" name="newfolder" id="newfolder" placeholder='Введите название папки'>
<!-- radius dropdown --> 
 <div class="nice  button split navigation-button-right">
...
<?php 
// echo "<pre>";
// print_r($params['breadcrumb']);
?>
<?php foreach($params['breadcrumb'] as $key => $value):?>
<?php if($key != 'Home') echo '&raquo;&nbsp;'?>
<a href="<?php echo $value?>"><?php echo $key == 'Home' ? 'Домашняя папка' : $key ?></a>
<?php endforeach;?>
</span>
</div>
