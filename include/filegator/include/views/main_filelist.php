		...
		<tr class="file">
			...
			<?php if (gatorconf::get('allow_file_links')):?>
			 <td class="filename">
				...
				<?php else : ?>
				  <span <?php if($file['buffer']!=false) echo 'class="'.$file['buffer'].'"';?> <?php if(gatorconf::get('use_lightbox_gallery') && $file['type'] == 'image') echo 'rel="lightbox[images]"';?> href="<?php echo gator::encodeurl($file['link'])?>" target="_blank"><?php echo $file['name']?></span>
				<?php endif;?>
			 </td>
			<?php else:?>
			 <td class="filename">
			  <span <?php if($file['buffer']!=false) echo 'class="'.$file['buffer'].'"';?>><?php echo $file['name']?></span>
			 </td>
			<?php endif;?>
