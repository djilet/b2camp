...
jQuery(function($) {
    ...
    ULTRA_SETTINGS.loginPage = function() {
        ...
        var formheight = $("#login").height()+60;
...
return;
    ...
    $(document).ready(function() {
        ...
        $('form.lockable').submit(function(e){
        	$(this).find('input[type=submit], button[type=submit]').prop('disabled', true);
        	ModalAlert(GetTranslation('lockable-form-alert-title'), GetTranslation('lockable-form-alert-content'));
        });
    });
